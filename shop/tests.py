...
class ProductViewTest(TestCase):
    def test_get_products(self):
        ...
        product_1 = Product.objects.create(title='Product 1', image=uploaded, category=category, slug='product-1')
        product_2 = Product.objects.create(title='Product 2', image=uploaded, category=category, slug='product-2')
...
class ProductDetailViewTest(TestCase):
    def test_get_product_by_slug(self):
        ...
        product = Product.objects.create(title='Product 1', category=category, slug='product-1', image=uploaded)
...
class CategoryListViewTest(TestCase):
    def setUp(self):
        ...
        self.product = ProductProxy.objects.create(title='Test Product', slug='test-product',
                                                   category=self.category, image=uploaded)
